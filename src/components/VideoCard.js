...
export default function VideoCard({ isTriggered, onVideoPlay, onVideoPause }) {
  ...
  return (
    <section className={styles.section}>
      ...
      >
        ...
        {/* Detailed Left Flower & Leaf Vine (Tangkai Bunga Sempurna) */}
        <svg className={styles.flowerLeft} viewBox="0 0 120 220" fill="none">
          ...
          {/* Main Ornate Stem (Tangkai Indah) */}
          <path 
          ...
          {/* Detailed Sage Leaves with Veins */}
          {/* Leaf 1 */}
          ...
          {/* Fully Bloomed Rose 1 (Vector layered petals) */}
          ...
          {/* Tiny decorative white baby-breath flowers */}
        ...
        {/* Detailed Right Flower & Leaf Vine (Mirrored & Perfected) */}
        ...
        {/* Dangling Ornaments Bottom Left (Swaying Heart & Star) */}
        ...
        {/* Dangling Ornaments Bottom Right (Swaying Star & Heart) */}
        <svg className={styles.hangingRight} viewBox="0 0 40 80">
          ...
          {/* Elegant Twinkling Star Ornament */}
        ...
        <div className={styles.videoWrapper}>
          ...
          {/* Floating Vector Hearts (Love particles) */}
